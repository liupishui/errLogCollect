...
;(function (global, factory) {
    ...
    var errLogCollect = function (options){
        ...
        this.getDevices = function () {
            ...
            if (/AppleWebKit.*Mobile/i.test(navigator.userAgent) || u.indexOf("Android") > -1 || u.indexOf("IEMobile") > -1 || (/MIDP|SymbianOS|NOKIA|SAMSUNG|LG|NEC|TCL|Alcatel|BIRD|DBTEL|Dopod|PHILIPS|HAIER|LENOVO|MOT-|Nokia|SonyEricsson|SIE-|Amoi|ZTE/.test(navigator.userAgent))) {
        ...
        this.uploadErrors = function () {
            ...
            for (var item in this.Errors) {
                errorMsg.push('[{"type":"' + this.Errors[item].type + '","jsErrorType":"' + this.Errors[item].jsErrorType + '","message":"' + this.Errors[item].message + '","col":"' + this.Errors[item].colno + '","line":"' + this.Errors[item].lineno+'","filename":"' + this.Errors[item].filename + '"}]');
            };
